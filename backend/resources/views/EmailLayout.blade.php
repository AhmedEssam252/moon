...
<body>
    <div class="app" style="background:#023047;overflow-x: hidden;">
        ...
        @yield('content')
        <div id="footer" class="section" style="display:grid;width: 100%;font-size: 18px;grid-auto-rows: auto;border-top: 40px solid #fff;background: #858585;margin-top:300px;position: relative;">
            <img src="https://dashboard.moonegypt.com/images/home/spaceShips2.svg" alt="" width="300px" height="190px" style="position: absolute;top:-65%;left:50%;transform:translate(-50%,0);">
